...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Vendas',
            data: [280, 100, 120, 310, 190], // Números originais
            backgroundColor: [
                'rgba(255, 0, 0, 0.2)', // Vermelho
                'rgba(255, 0, 0, 0.2)', // Azul
                'rgba(255, 0, 0, 0.2)', // Amarelo
                'rgba(255, 0, 0, 0.2)', // Verde-água
                'rgba(255, 0, 0, 0.2)' // Roxo
            ],
            borderColor: [
                'rgba(255, 0, 0, 1)', // Vermelho
                'rgba(255, 0, 0, 1)', // Azul
                'rgba(255, 0, 0, 1)', // Amarelo
                'rgba(255, 0, 0, 1)', // Verde-água
                'rgba(255, 0, 0, 1)' // Roxo
            ],
            borderWidth: 1,
            datalabels: {
                ...
                color: '#F05454' // Cor vermelha para os rótulos de dados
            }
        }]
    },
    options: {
        ...
        scales: {
            x: {
                ticks: {
                    color: '#F05454' // Cor vermelha para os rótulos dos meses
                },
                title: {
                    display: true,
                    text: 'Cafés',
            ...
            y: {
                beginAtZero: true,
                ticks: {
                    color: '#F05454', // Cor vermelha para os rótulos dos números
